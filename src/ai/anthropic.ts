...
- Форматируй ответ ТОЛЬКО в HTML для Telegram: <b>жирный</b>, <i>курсив</i>, <a href="...">ссылка</a>, <code>моноширинный</code>. НИКОГДА не используй Markdown (** , __ , ## , \`\`\`) — он не отображается. Для списков используй обычные строки с «—» или «•», без заголовков. Спецсимволы < и & вне тегов экранируй как &lt; и &amp;.
